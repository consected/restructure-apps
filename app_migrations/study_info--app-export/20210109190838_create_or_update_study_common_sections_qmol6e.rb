...
class CreateOrUpdateStudyCommonSectionsQmol6e < ActiveRecord::Migration[5.2]
  include ActiveRecord::Migration::AppGenerator

  def change
    self.schema = 'study_info'
    self.table_name = 'study_common_sections'
    self.fields = %i[title content position_number block_width extra_classes]
    self.table_comment = 'Dynamicmodel: Common Section'
