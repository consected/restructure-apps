...
class CreateOrUpdateSleepPsInitialScreeningsQmow7k < ActiveRecord::Migration[5.2]
  include ActiveRecord::Migration::AppGenerator

  def change
    self.schema = 'study_info'
    self.table_name = 'sleep_ps_initial_screenings'
    self.fields = %i[select_is_good_time_to_speak any_questions_blank_yes_no question_notes select_still_interested follow_up_date follow_up_time notes]
